...
//   // Debug logging
//   console.log('ProductSelection received products:', products);
//   if (products && products.length > 0) {
//     const firstProduct = products[0];
//     console.log('First product full object:', firstProduct);
//     console.log('First product requested_quantity:', firstProduct.requested_quantity);
//     console.log('First product quantity:', firstProduct.quantity);
//     console.log('First product keys:', Object.keys(firstProduct));
//   }

//   // Monitor products changes
//   useEffect(() => {
//     console.log('Products changed in useEffect:', products);
//     if (products && products.length > 0) {
//       console.log('First product in useEffect:', products[0]);
//     }
//   }, [products]);

//   // Helper function to get quantity from product (handles both transformed and raw backend data)
//   const getProductQuantity = (product) => {
//     return product.requested_quantity ?? product.quantity ?? 1;
//   };

//   // Helper function to get unit price from product
//   const getProductUnitPrice = (product) => {
//     return product.unit_price ?? product.totale ?? product.price ?? 0;
//   };
...
//                   <span className="font-medium">Qty:</span> {getProductQuantity(product)}
//                 </div>
...
//                       €{getProductUnitPrice(product).toFixed(2)} each
//                     </span>
//                     <span className="text-xs text-blue-600 dark:text-blue-400 font-medium">
//                       Total: €{(getProductUnitPrice(product) * getProductQuantity(product)).toFixed(2)}
//                     </span>
//                     {product.quota_gse > 0 && (
...
//                     €{(getProductUnitPrice(product) * getProductQuantity(product)).toFixed(2)}
//                   </div>
//                   <div className="text-xs text-gray-500 dark:text-gray-400">
//                     total for {getProductQuantity(product)}
//                   </div>
//                 </td>
//                 <td className="py-3 px-4 text-right">
//                   <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between mt-2">
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-blue-600 dark:text-blue-400 font-medium">
                      Total: €{(product.unit_price * product.quantity).toFixed(2)}
                    </span>
                    {product.quota_gse > 0 && (
                      <span className="text-xs text-gray-500 dark:text-gray-400">
